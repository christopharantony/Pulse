  ...
  return (
    <Card className="flex flex-col gap-4">
      <div className="flex items-center justify-between">
        <h1 className="text-h2 text-foreground">Active goals</h1>
        <GoalCreateDialog
          trigger={
      ...
      <GoalList
        query={{ status: ['not_started', 'active', 'on_hold'], includeArchived: false, limit: 100, sortBy: 'targetDate', sortDir: 'asc' }}
        emptyTitle="No active goals"
        emptyDescription="Set a goal to give your work direction."
