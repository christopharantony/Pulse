...
import { permanentlyDeleteHabit } from '@/features/habits/services/habits.service';
...
export async function DELETE(_request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    await permanentlyDeleteHabit(ctx, new ObjectId(id));
    return ok(null, 'Habit permanently deleted');
  } catch (error) {
